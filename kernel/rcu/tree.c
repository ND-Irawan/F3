...
void __init rcu_init(void)
{
	...
	rcu_gp_wq = alloc_workqueue("rcu_gp", WQ_HIGHPRI | WQ_UNBOUND | WQ_POWER_EFFICIENT | WQ_MEM_RECLAIM, 0);
	WARN_ON(!rcu_gp_wq);
	rcu_par_gp_wq = alloc_workqueue("rcu_par_gp", WQ_HIGHPRI | WQ_UNBOUND | WQ_POWER_EFFICIENT | WQ_MEM_RECLAIM, 0);
